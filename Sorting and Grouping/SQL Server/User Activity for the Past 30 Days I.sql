/*
NOTE: The original problem statement can feel unclear about what exactly should be counted although its easy.
so their is explanation if u feel lost in the problem description

The question asks us to return, for each day in the 30-day period ending on 2019-07-27
(meaning we only consider activities between '2019-06-28' and '2019-07-27'), the number of users who were active on that day.
